...
-- Crear una vista temporal, LAG datos fila anterior, LEAD datos fila siguiente
...
-- crear una tabla temporal, union all = concatenar
...
SELECT
  *
FROM
  health_tracker_silver VERSION AS OF 1
...
-- Info tabla HISTORY con los cambios que se han hecho
