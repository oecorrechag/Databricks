...
-- busqueda para filtar, sacando del array el elemento Engineering Blog, categories es el array, category es el iterador
SELECT
  categories,
...
-- busqueda para filtar, tomando solo arrays con elemento Engineering Blog (los demas los deja vacios), luego toma los arrays que tengan almenos 1 elemento
SELECT
  *
FROM
  (
...
-- busqueda para revisar si en la columna arreglos categories existe el valor de Company Blog
SELECT
  categories,
...
-- busqueda para transformar en minusculas
SELECT 
