...
-- info de la tabla EXTENDED para mostar todas las columnas
...
-- MAGIC CREATE TABLE users USING parquet OPTIONS (
-- MAGIC   PATH "/mnt/training/ecommerce/users/users.parquet"
-- MAGIC )
...
FROM
 purchaseEvents pe 
JOIN users usr ON pe.userId = usr.user_id
