...
-- Ver tabla, 5 filas tomadas aleatoriamente
...
-- crea una tabla con particionamiento por la variable p_device_id y transforma 2 variables
...
-- ingresa nuevos datos a una tabla ya existente health_tracker_silver
INSERT INTO
  health_tracker_silver
SELECT
  value.name,
...
-- busqueda, VERSION AS OF 0 hace referencia a la version 0 original
...
-- busqueda sobre la tabla actual (con los add)
...
-- busqueda, contar cuantos registro hay por id
