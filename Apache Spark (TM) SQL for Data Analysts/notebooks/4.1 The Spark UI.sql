...
-- crear una vista temporal con las anteriores condiciones
...
-- tiempo de consulta por primera vez
...
-- tiempo de consulta por segunda vez
SELECT * FROM filtered;

-- COMMAND ----------

-- busqueda sobre tabla cuando esta en cache
...
-- busqueda sobre tabla cuando no esta en cache
SELECT * FROM filtered WHERE firstName = "Latisha";
...
-- busqueda sobre tabla particionada
